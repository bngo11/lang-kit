...
SRC_URI="amd64? (
  https://github.com/tinygo-org/tinygo/releases/download/v0.40.0/tinygo0.40.0.linux-amd64.tar.gz -> tinygo0.40.0.linux-amd64.tar.gz
)
arm64? (
  https://github.com/tinygo-org/tinygo/releases/download/v0.40.0/tinygo0.40.0.linux-arm64.tar.gz -> tinygo0.40.0.linux-arm64.tar.gz
)
"
