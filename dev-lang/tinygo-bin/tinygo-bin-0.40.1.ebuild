...
SRC_URI="amd64? (
  https://github.com/tinygo-org/tinygo/releases/download/v0.40.1/tinygo0.40.1.linux-amd64.tar.gz -> tinygo0.40.1.linux-amd64.tar.gz
)
arm64? (
  https://github.com/tinygo-org/tinygo/releases/download/v0.40.1/tinygo0.40.1.linux-arm64.tar.gz -> tinygo0.40.1.linux-arm64.tar.gz
)
"
