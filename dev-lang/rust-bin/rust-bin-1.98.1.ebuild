...
SRC_URI="
		abi_x86_64? ( 
		https://static.rust-lang.org/dist/rust-1.98.1-x86_64-unknown-linux-gnu.tar.xz -> rust-1.98.1-x86_64-unknown-linux-gnu.tar.xz
	)
	arm? ( 
		https://static.rust-lang.org/dist/rust-1.98.1-arm-unknown-linux-gnueabi.tar.xz -> rust-1.98.1-arm-unknown-linux-gnueabi.tar.xz
		https://static.rust-lang.org/dist/rust-1.98.1-arm-unknown-linux-gnueabihf.tar.xz -> rust-1.98.1-arm-unknown-linux-gnueabihf.tar.xz
		https://static.rust-lang.org/dist/rust-1.98.1-armv7-unknown-linux-gnueabihf.tar.xz -> rust-1.98.1-armv7-unknown-linux-gnueabihf.tar.xz
	)
	arm64? ( 
		https://static.rust-lang.org/dist/rust-1.98.1-aarch64-unknown-linux-gnu.tar.xz -> rust-1.98.1-aarch64-unknown-linux-gnu.tar.xz
	)
	riscv64? ( 
		https://static.rust-lang.org/dist/rust-1.98.1-riscv64gc-unknown-linux-gnu.tar.xz -> rust-1.98.1-riscv64gc-unknown-linux-gnu.tar.xz
	)
	rust-src? (
		https://static.rust-lang.org/dist/rust-src-1.98.1.tar.xz -> rust-src-1.98.1.tar.xz
	)
	wasm? (
		https://static.rust-lang.org/dist/rust-std-1.98.1-wasm32-unknown-unknown.tar.xz -> rust-std-1.98.1-wasm32-unknown-unknown.tar.xz
	)
	wasm-wasip1? (
		https://static.rust-lang.org/dist/rust-std-1.98.1-wasm32-wasip1.tar.xz -> rust-std-1.98.1-wasm32-wasip1.tar.xz
	)
	wasm-wasip2? (
		https://static.rust-lang.org/dist/rust-std-1.98.1-wasm32-wasip2.tar.xz -> rust-std-1.98.1-wasm32-wasip2.tar.xz
	)
"
