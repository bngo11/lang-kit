...
SRC_URI="
	...
	wasm-wasip2? (
		https://static.rust-lang.org/dist/rust-std-1.89.0-wasm32-wasip2.tar.xz -> rust-std-1.89.0-wasm32-wasip2.tar.xz
	)
"
...
src_unpack() {
	...
	mv "${WORKDIR}/${MY_P}-$(rust_abi)" "${S}" || die
		...
		if use wasm-wasip2; then
				mv "${WORKDIR}/rust-std-1.89.0-wasm32-wasip2/rust-std-wasm32-wasip2" "${S}"/rust-std-wasm32-wasip2
		fi
}
