...
SRC_URI="
		abi_x86_64? ( 
		https://static.rust-lang.org/dist/rust-1.93.1-x86_64-unknown-linux-gnu.tar.xz -> rust-1.93.1-x86_64-unknown-linux-gnu.tar.xz
	)
	arm? ( 
		https://static.rust-lang.org/dist/rust-1.93.1-arm-unknown-linux-gnueabi.tar.xz -> rust-1.93.1-arm-unknown-linux-gnueabi.tar.xz
		https://static.rust-lang.org/dist/rust-1.93.1-arm-unknown-linux-gnueabihf.tar.xz -> rust-1.93.1-arm-unknown-linux-gnueabihf.tar.xz
		https://static.rust-lang.org/dist/rust-1.93.1-armv7-unknown-linux-gnueabihf.tar.xz -> rust-1.93.1-armv7-unknown-linux-gnueabihf.tar.xz
	)
	arm64? ( 
		https://static.rust-lang.org/dist/rust-1.93.1-aarch64-unknown-linux-gnu.tar.xz -> rust-1.93.1-aarch64-unknown-linux-gnu.tar.xz
	)
	riscv64? ( 
		https://static.rust-lang.org/dist/rust-1.93.1-riscv64gc-unknown-linux-gnu.tar.xz -> rust-1.93.1-riscv64gc-unknown-linux-gnu.tar.xz
	)
	rust-src? (
		https://static.rust-lang.org/dist/rust-src-1.93.1.tar.xz -> rust-src-1.93.1.tar.xz
	)
	wasm? (
		https://static.rust-lang.org/dist/rust-std-1.93.1-wasm32-unknown-unknown.tar.xz -> rust-std-1.93.1-wasm32-unknown-unknown.tar.xz
	)
	wasm-wasip1? (
		https://static.rust-lang.org/dist/rust-std-1.93.1-wasm32-wasip1.tar.xz -> rust-std-1.93.1-wasm32-wasip1.tar.xz
	)
	wasm-wasip2? (
		https://static.rust-lang.org/dist/rust-std-1.93.1-wasm32-wasip2.tar.xz -> rust-std-1.93.1-wasm32-wasip2.tar.xz
	)
"
...
src_unpack() {
	...
	mv "${WORKDIR}/${MY_P}-$(rust_abi)" "${S}" || die
		if use rust-src; then
				mv "${WORKDIR}/rust-src-1.93.1/rust-src" "${S}"/rust-src
		fi
		if use wasm; then
				mv "${WORKDIR}/rust-std-1.93.1-wasm32-unknown-unknown/rust-std-wasm32-unknown-unknown" "${S}"/rust-std-wasm32-unknown-unknown
		fi
		if use wasm-wasip1; then
				mv "${WORKDIR}/rust-std-1.93.1-wasm32-wasip1/rust-std-wasm32-wasip1" "${S}"/rust-std-wasm32-wasip1
		fi
		if use wasm-wasip2; then
				mv "${WORKDIR}/rust-std-1.93.1-wasm32-wasip2/rust-std-wasm32-wasip2" "${S}"/rust-std-wasm32-wasip2
		fi
}
